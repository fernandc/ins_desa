<div class="modal-header">
    <h5 class="modal-title" id="exampleModalCenterTracingTitle">
        <Fieldset>Ficha de Alumno</Fieldset>
    </h5>
...
<div class="modal-body">
    ...
    <main id="content" class="border" style="padding: 20px;">
        ...
        <div class="my-3">
            <p class="font-weight-bold" style="font-size: 10pt;">N° de matrícula: &nbsp;&nbsp;<span style="text-decoration: underline;white-space: break-spaces;">
                    <?php echo str_pad($data["inscription"]["numero_matricula"], 20, " ", STR_PAD_BOTH); ?>
                </span></p>
            <p class="font-weight-bold" style="font-size: 10pt;display: none;">Centro de padres: <span style="text-decoration: underline;white-space: break-spaces;">
                    <?php echo str_pad($data["inscription"]["centro_padres"], 20, " ", STR_PAD_BOTH); ?>
                </span></p>
            <p class="font-weight-bold" style="font-size: 10pt;">Centro de padres: <span style="text-decoration: underline;white-space: break-spaces;">
                    <?php echo str_pad("", 20, "_", STR_PAD_BOTH); ?>
                </span></p>
